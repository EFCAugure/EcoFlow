...
<form class="form-horizontal">
  <fieldset>
    <div class="form-group">
      <label class="col-md-6 control-label">{{Url Api EcoFlow}}
        <sup><i class="fas fa-question-circle tooltips" title="{{Renseignez l'url cloud de l'api fournie jusqu'à ?sn=}}"></i></sup>
      </label>
      <div class="col-md-6"> 
        <input class="configKey form-control" data-l1key="EcoApiUrl" placeholder="https://api.ecoflow.com/iot-service/open/api/device/queryDeviceQuota?sn="/>
      </div>
    <!--
    </div>
    <div class="form-group">
